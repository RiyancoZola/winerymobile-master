...
public class ListTransactionDetailPendingJurtul extends AppCompatActivity {
    ...
    @BindView(R.id.iv_file_npwp)
    ImageView ivFileNpwp;
    ...
    String imageKtp,imageDataKotor,imageNpwp,imageSlipGaji,imageFileNpwp,imageSpt,imageKartuKredit,imageDoc2;
    ...
    @OnClick(R.id.iv_slip_gaji) void pinchZoomDataSlip() { pinchToZoom(imageSlipGaji); }

    @OnClick(R.id.iv_file_npwp) void pinchZoomFileNpwp() { pinchToZoom(imageFileNpwp); }
                        ...
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                if (jsonRESULTS.getInt("status") == 200) {
                                    ...
                                    imageFileNpwp = jsonRESULTS.getJSONObject("data").getString("url_file_npwp");
